...
$request_string = htmlentities("<OTA_VehResRQ Version='1.002'>
            ...
            <RateDistance Unlimited='".$rateDistanceTag."'".$rateDistance." />
                ...
                <Customer>
                    <Primary>
                        <PersonName>
                            <GivenName>", ENT_COMPAT, "UTF-8") . normaliza($nome_completo) . htmlentities("</GivenName>
                            <Surname>", ENT_COMPAT, "UTF-8") . normaliza($this->sobrenome_emissor) . htmlentities("</Surname>
                        </PersonName>
